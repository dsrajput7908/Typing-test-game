document.addEventListener('DOMContentLoaded', () => {
    ...
    const timeTag = document.querySelector(".result-details .time span b");
    const mistakeTag = document.querySelector(".result-details .mistake span");
    const wpmTag = document.querySelector(".result-details .wpm span");
    const cpmTag = document.querySelector(".result-details .cpm span");
